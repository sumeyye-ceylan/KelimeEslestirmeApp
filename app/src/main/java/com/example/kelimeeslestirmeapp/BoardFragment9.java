...
public class BoardFragment9 extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        modelListLeft.add(new Model("Dress", "Elbise", 0));
        modelListLeft.add(new Model("Trousers", "Pantolon", 1));
        modelListLeft.add(new Model("Suit", "Takım elbise", 2));
        modelListLeft.add(new Model("Skirt", "Etek", 3));
        modelListLeft.add(new Model("Socks", "Çorap", 4));
        modelListLeft.add(new Model("Jacket", "Ceket", 5));
        modelListLeft.add(new Model("Sweater", "Süveter", 6));
        modelListLeft.add(new Model("Shoe", "Ayakkabı", 7));
        modelListLeft.add(new Model("Hat", "Şapka", 8));
        modelListLeft.add(new Model("Tie", "Kravat", 9));
        modelListLeft.add(new Model("Shirt", "Gömlek", 10));
