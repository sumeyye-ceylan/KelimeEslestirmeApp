...
public class BoardFragment2 extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        modelListLeft.add(new Model("red", "kırmızı", 0));
        modelListLeft.add(new Model("white", "beyaz", 1));
        modelListLeft.add(new Model("blue", "mavi", 2));
        modelListLeft.add(new Model("yellow", "sarı", 3));
        modelListLeft.add(new Model("black", "siyah", 4));
        modelListLeft.add(new Model("orange", "turuncu", 5));
        modelListLeft.add(new Model("pink", "pembe", 6));
        modelListLeft.add(new Model("brown", "kahverengi", 7));
        modelListLeft.add(new Model("green", "yeşil", 8));
        modelListLeft.add(new Model("grey", "gri", 9));
        modelListLeft.add(new Model("navy blue", "lacivert", 10));
