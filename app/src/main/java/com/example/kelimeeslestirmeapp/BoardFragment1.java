...
public class BoardFragment1 extends Fragment {
    ...
    private  View.OnTouchListener touchlistener =new View.OnTouchListener(){
        @Override //dokunduğumuz yerin koordinatlarını alıp öyle animasyonlu bir şekilde ayrılıyoruz
    ...
    private  View.OnClickListener clicklistenerLeft =new View.OnClickListener(){
        ...
        public void onClick(View view) {
            ...
            if(selectButtonRight !=null ){
                //eşleştirme  kontrolü yapılıyor seçili olanlar eşleşirse Blue eşleşmezse de Rede gidecek
                ...
                if (selectButtonLeft !=null) { //seçilli değilse beyaz kalacak butonlar seçili ise de gri bir renk
    ...
    private  View.OnClickListener clicklistenerRight =new View.OnClickListener(){
        ...
        public void onClick(View view) {
            ...
            if(selectButtonLeft !=null ){
                //eşleştirme  kontrolü  yapılıyor aynı işlemleri sol taraf için de yapıyoruz
    ...
    private  void  girisAnimasyonu(){
        ...
        Button button= (Button) containerLeft.getChildAt(5-i);
            ObjectAnimator animator=ObjectAnimator.ofFloat(button ,"translationX",-widthButton*1.5f,0); // soldan sağa doğru gelsin diye
       animator.setInterpolator(new AccelerateDecelerateInterpolator()); // duraklayarak gelmesi için hızlanıp yavaşlama
       animator.setDuration(DURATION + i*70 ); // alttan yukarı geliş sürelerini verdim
       animator.start();
        }
