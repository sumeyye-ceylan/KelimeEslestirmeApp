...
public class BoardFragment5 extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        modelListLeft.add(new Model("Engineer", "Mühendis", 0));
        modelListLeft.add(new Model("Teacher", "Öğretmen", 1));
        modelListLeft.add(new Model("Policeman", "Polis", 2));
        modelListLeft.add(new Model("Doctor", "Doktor", 3));
        modelListLeft.add(new Model("Postman", "Postacı", 4));
        modelListLeft.add(new Model("Cook", "Aşcı", 5));
        modelListLeft.add(new Model("Architect", "Mimar", 6));
        modelListLeft.add(new Model("Lawyer", "Avukat", 7));
        modelListLeft.add(new Model("Nurse", "Hemşire", 8));
        modelListLeft.add(new Model("Painter", "Boyacı", 9));
        modelListLeft.add(new Model("Fireman", "İtfaiyeci", 10));
