...
public class BoardFragment8 extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        modelListLeft.add(new Model("Cat", "Kedi", 0));
        modelListLeft.add(new Model("Dog", "Köpek", 1));
        modelListLeft.add(new Model("Fox", "Tilki", 2));
        modelListLeft.add(new Model("Lion", "Arslan", 3));
        modelListLeft.add(new Model("Bird", "Kuş", 4));
        modelListLeft.add(new Model("Cow", "İnek", 5));
        modelListLeft.add(new Model("Snake", "Yılan", 6));
        modelListLeft.add(new Model("Panda", "Panda", 7));
        modelListLeft.add(new Model("Mouse", "Fare", 8));
        modelListLeft.add(new Model("Rabbit", "Tavşan", 9));
        modelListLeft.add(new Model("Horse", "At", 10));
