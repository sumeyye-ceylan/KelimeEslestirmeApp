...
public class BoardFragment3 extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        modelListLeft.add(new Model("Ruler", "Cetvel", 0));
        modelListLeft.add(new Model("Map", "Harita", 1));
        modelListLeft.add(new Model("Open the door", "Kapıyı açınız", 2));
        modelListLeft.add(new Model("Paint", "Boya", 3));
        modelListLeft.add(new Model("Cut", "Kesmek", 4));
        modelListLeft.add(new Model("Draw", "Çizmek", 5));
        modelListLeft.add(new Model("Table", "Sıra", 6));
        modelListLeft.add(new Model("Book", "Kitap", 7));
        modelListLeft.add(new Model("Board", "Tahta", 8));
        modelListLeft.add(new Model("Glue", "Yapıştırıcı", 9));
        modelListLeft.add(new Model("Eraser", "Silgi", 10));
