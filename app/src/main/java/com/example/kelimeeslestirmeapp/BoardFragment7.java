...
public class BoardFragment7 extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        modelListLeft.add(new Model("Orange", "Portakal", 0));
        modelListLeft.add(new Model("Apple", "Elma", 1));
        modelListLeft.add(new Model("Banana", "Muz", 2));
        modelListLeft.add(new Model("Cherry", "Kiraz", 3));
        modelListLeft.add(new Model("Apricot", "Kayısı", 4));
        modelListLeft.add(new Model("Domato", "Domates", 5));
        modelListLeft.add(new Model("Onion", "Soğan", 6));
        modelListLeft.add(new Model("Strawberry", "Çilek", 7));
        modelListLeft.add(new Model("Potato", "Patates", 8));
        modelListLeft.add(new Model("Plum", "Erik", 9));
        modelListLeft.add(new Model("Mint", "Nane", 10));
