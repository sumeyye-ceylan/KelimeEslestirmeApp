...
public class BoardFragment6 extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        modelListLeft.add(new Model("Turkey", "Türkiye", 0));
        modelListLeft.add(new Model("China", "Çin", 1));
        modelListLeft.add(new Model("USA", "Amerika", 2));
        modelListLeft.add(new Model("Germany", "Almanya", 3));
        modelListLeft.add(new Model("Japan", "Japonya", 4));
        modelListLeft.add(new Model("Argentina", "Arjantin", 5));
        modelListLeft.add(new Model("Australia", "Avusruralya", 6));
        modelListLeft.add(new Model("UK", "İngiltere", 7));
        modelListLeft.add(new Model("Canada", "Kanada", 8));
        modelListLeft.add(new Model("Brezil", "Brezilya", 9));
        modelListLeft.add(new Model("Ireland", "İrlanda", 10));
